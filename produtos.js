...
// let vendaTotal = produtos.reduce((acumulador, produto) => acumulador + ((produto.preco_venda * produto.estoque) - produto.preco_compra), 0)
// console.log(vendaTotal.toLocaleString("pt-BR", {style: "currency", currency: "BRL" } ))

// let estoqueTotal = produtos.reduce((acumulador, produto) => acumulador + (produto.estoque))
